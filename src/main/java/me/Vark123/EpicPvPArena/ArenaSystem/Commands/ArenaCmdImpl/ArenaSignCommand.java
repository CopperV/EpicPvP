...
public class ArenaSignCommand extends AArenaCommand {
	...
	public boolean useCommand(Player sender, String... args) {
		...
		PvPArenaManager.get().signUpPlayer(pp);
		return true;
	}

	@Override
	public void showCorrectUsage(Player sender) {
		sender.sendMessage("  §e/arena zapisz §7- Zapisz sie na walki na arenach PvP");
